...
function DatePick({ value, onChange, label, compact }) {
  ...
  return <div ref={ref} style={{ position: "relative" }}>
    ...
    {open && createPortal(<div id="datepick-portal" style={{ position: "fixed", top: popPos.top, left: popPos.left, zIndex: 9999, background: T.bg, border: `1px solid ${T.border}`, borderRadius: T.r, boxShadow: "0 12px 40px rgba(0,0,0,.5)", padding: compact ? "10px" : "14px", minWidth: compact ? 220 : 260, backdropFilter: "blur(20px)" }} onClick={e => e.stopPropagation()} onPointerDown={e => e.stopPropagation()} onMouseDown={e => e.stopPropagation()}>
