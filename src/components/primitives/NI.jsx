...
function NI({ value, onChange, fmt = "$", disabled, color }) {
  ...
  return <button onClick={start} disabled={disabled} style={{ background: "transparent", border: "none", color: value === 0 ? T.dim : (color||T.cream), textAlign: "right", width: "100%", padding: "3px 0", fontSize: 13, fontFamily: T.mono, cursor: disabled ? "default" : "pointer", borderRadius: 4, opacity: disabled ? .5 : 1 }}
