...
export const mkVendor = (name, email = "", phone = "", notes = "", w9Status = "pending", vendorType = "other", contactName = "") => ({ id: uid(), name, email, phone, notes, w9Status, vendorType, contactName });
