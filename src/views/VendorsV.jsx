...
function VendorsV({project,updateProject,canEdit,onVendorClick}){
  ...
  return<div>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:24}}>
      <div><h1 style={{fontSize:20,fontWeight:600,color:T.cream,letterSpacing:"-0.01em"}}>Vendors</h1><p style={{fontSize:13,color:T.dim,marginTop:6}}>{vendors.length} vendors{w9Pending>0?<span style={{color:"#FBBF24"}}> · {w9Pending} W-9 pending</span>:""}</p></div>
