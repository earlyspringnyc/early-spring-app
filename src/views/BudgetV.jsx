...
function BudgetV(p){
  ...
  return<div>
    ...
    <div style={{display:"flex",gap:10,alignItems:"center",marginTop:24,flexWrap:"wrap"}}>
      ...
      {canEdit&&proj.sheetImport&&<button onClick={()=>setShowSheetSync(true)} style={{padding:"8px 14px",background:"rgba(255,234,151,.06)",color:T.gold,border:`1px solid rgba(255,234,151,.2)`,borderRadius:T.rS,fontSize:11,fontWeight:600,cursor:"pointer",fontFamily:T.sans}}>Sync from Sheet</button>}
