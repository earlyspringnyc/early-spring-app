...
function DocsV({project,updateProject,canEdit,vendors,onAddVendor,onVendorClick}){
  ...
  return<div onDragEnter={onDragEnter} onDragLeave={onDragLeave} onDragOver={onDragOver} onDrop={onDrop} style={{position:"relative",minHeight:"50vh"}}>
    ...
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:24}}>
      <div><h1 style={{fontSize:24,fontWeight:600,color:T.cream,letterSpacing:"-0.02em"}}>Documents</h1><p style={{fontSize:13,color:T.dim,marginTop:6,fontFamily:T.serif,fontStyle:"italic"}}>{docs.length} documents{overdueCount>0?<span style={{color:T.neg,fontWeight:600}}> · {overdueCount} overdue</span>:""}</p></div>
