...
function DashV({cats,comp,feeP,project}){
  ...
  return<div>
    <div style={{marginBottom:24}}><h1 style={{fontSize:20,fontWeight:600,color:T.cream,letterSpacing:"-0.01em"}}>Dashboard</h1><p style={{fontSize:13,color:T.dim,marginTop:6}}>Project overview and financial snapshot</p></div>
...
{(overdueDocs.length>0||unpaidInvoices.length>0)&&<Card style={{padding:18,marginBottom:16,borderColor:overdueDocs.length>0?"rgba(248,113,113,.2)":"rgba(255,234,151,.12)",background:overdueDocs.length>0?"rgba(248,113,113,.03)":"rgba(255,234,151,.02)"}}>
    ...
    {(allUpcoming.length>0||overdueTasks.length>0)&&<Card style={{padding:18,marginBottom:16,borderColor:"rgba(255,234,151,.12)",background:"rgba(255,234,151,.02)"}}>
      ...
      {overdueTasks.map(t=><div key={t.id} style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"7px 12px",marginBottom:3,borderRadius:T.rS,background:"rgba(248,113,113,.06)"}}>
        <div style={{display:"flex",alignItems:"center",gap:6}}><span style={{fontSize:10,fontWeight:700,padding:"2px 6px",borderRadius:6,background:"rgba(248,113,113,.15)",color:T.neg}}>LATE</span><span style={{fontSize:12,color:T.cream}}>{t.name}</span></div>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14,marginBottom:14}}>
      <Card style={{padding:24}}><div style={{fontSize:12,fontWeight:600,fontFamily:T.mono,textTransform:"uppercase",letterSpacing:".08em",color:T.cream,marginBottom:18}}>Spend Distribution</div>
