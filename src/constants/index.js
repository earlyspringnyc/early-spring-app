...
export const ROLES = ["admin", "producer", "creative", "finance", "accounts", "production", "client"];
export const ROLE_LABELS = { admin: "Admin", producer: "Producer", creative: "Creative", finance: "Finance", accounts: "Accounts", production: "Production", client: "Client" };
export const ROLE_COLORS = { admin: T.gold, producer: T.cyan, creative: T.magenta, finance: T.pos, accounts: T.blue, production: "#FDBA74", client: T.dim };
